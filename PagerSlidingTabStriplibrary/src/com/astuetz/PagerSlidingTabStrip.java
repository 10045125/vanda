...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int selectTabTextSize = tabTextSize;
	...
	public void setSelectTabTextSize(int selectTabTextSize) {
		this.selectTabTextSize = selectTabTextSize;
	}
	...
	public void setTextSize(int textSizePx) {
		...
		this.selectTabTextSize = textSizePx;
		updateTabStyles();
	}
